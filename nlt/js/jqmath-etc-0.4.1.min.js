...
function(widthS,docP){return M.newMe("mspace",null,{width:widthS},docP)};M.fenceMe=function(me1,leftP,rightP,docP){return M.newMe("mrow",[M.newMe("mo",leftP==null?"(":leftP,docP),me1,M.newMe("mo",rightP==null?")":rightP,docP)],docP)};F.iter(function(tagName){M[tagName]=F(M.newMe,tagName)},["mn","mi","mo","mtext","mspace","mrow","mfenced","mfrac","msqrt","mroot","msub","msup","msubsup","mmultiscripts","mprescripts","none","munder","mover","munderover","mtable","mtr","mtd","mstyle","merror","mpadded",
"mphantom","menclose"]);M.setMathBlockQ=function(e,blockQ){if(blockQ){e.setAttribute("display","block");M.addClass(e,"ma-block")}else if(!M.MathML)$(e).addClass("fm-inline");return e};M.math=function(argsP,blockQ,docP){return M.setMathBlockQ(M.newMe("math",argsP,docP),blockQ)};M.eToMathE=function(mathE){if(M.MathML==null||mathE.tagName.toLowerCase()!="math")F.err(err_eToMathE_);function fixMathMLDeep(nod){if(nod.nodeType!=1)return nod;if(!F.elem(nod.tagName,mtokens_))F.iter(fixMathMLDeep,nod.childNodes);
return checkMathMLAttrs(nod)}if(M.MathML&&mathE.tagName=="math")return fixMathMLQ_?fixMathMLDeep(mathE):mathE;var doc=mathE.ownerDocument;function newMeDeep(me){var tagName=me.tagName.toLowerCase(),args=me.childNodes;function nodeToMes(nod){if(nod.nodeType==3)return/^\s*$/.test(nod.data)?[]:[M.mtext(nod.data,doc)];if(nod.nodeType==8)return[];me.nodeType==1||F.err(err_newMeDeep_);return[newMeDeep(nod)]}if(F.elem(tagName,mtokens_)){if(tagName=="mo"&&args.length==1&&args[0].nodeType==3&&args[0].data==
"-")args=M["-"]}else args=F.concatMap(nodeToMes,args);var res=M.newMe(tagName,args,me.attributes,doc);if(tagName=="math")M.setMathBlockQ(res,me.getAttribute("display")=="block");return res}return newMeDeep(mathE)};M["-"]="\u2212";M.trimNumS=function(s){return s.replace(/(\d\.\d*?)0+(?!\d)/g,"$1").replace(/(\d)\.(?!\d)/g,"$1").replace(/[-\u2212]0(?![.\d])/g,"0")};M.numS=function(s,trimQ){if(trimQ)s=M.trimNumS(s);return s.replace(/Infinity/ig,"\u221e").replace(/NaN/ig,"{?}").replace(/e(-\d+)/ig,"\u00b710^{$1}").replace(/e\+?(\d+)/ig,
"\u00b710^$1").replace(/-/g,M["-"])};M.combiningChar_="[\u0300-\u036f\u1dc0-\u1dff\u20d0-\u20ff\ufe20-\ufe2f]";M.surrPair_="[\ud800-\udbff][\udc00-\udfff]";var decComma_,escPat_="[\\\\`]([A-Za-z]+|.)";M.decimalComma=function(qP){if(qP!=null){decComma_=qP;var numPat=(qP?"\\d*,\\d+|":"")+"\\d+\\.?\\d*|\\.\\d+";M.re_=RegExp("("+numPat+")|"+escPat_+"|"+M.surrPair_+"|\\S"+M.combiningChar_+"*","g")}return decComma_};var commaLangs="af|an|ar|av|az|ba|be|bg|bs|ca|ce|co|cs|cu|cv|da|de|el|es|et|eu|fi|fo|fr|"+
"gl|hr|hu|hy|id|is|it|jv|kk|kl|kv|lb|lt|lv|mk|mn|mo|nl|no|os|pl|pt|ro|ru|sc|sk|sq|sr|"+"su|sv|tr|tt|ug|uk|vi|yi";M.decimalComma(RegExp("^("+commaLangs+")\\b","i").test(document.documentElement.lang));M.infix_={"\u2282\u20d2":240,"\u2283\u20d2":240,"\u226a\u0338":260,"\u226b\u0338":260,"\u2aaf\u0338":260,"\u2ab0\u0338":260,"\u223d\u0331":265,"\u2242\u0338":265,"\u224e\u0338":265,"\u224f\u0338":265,"\u2266\u0338":265,"\u227f\u0338":265,"\u228f\u0338":265,"\u2290\u0338":265,"\u29cf\u0338":265,"\u29d0\u0338":265,
"\u2a7d\u0338":265,"\u2a7e\u0338":265,"\u2aa1\u0338":265,"\u2aa2\u0338":265,"\u2009":390,"":500};M.prefix_={};M.postfix_={};function setPrecs(precs,precCharsA){F.iter(function(prec_chars){var prec=prec_chars[0];F.iter(function(c){precs[c]=prec},prec_chars[1].split(""))},precCharsA)}setPrecs(M.infix_,[[21,"|"],[30,";"],[40,",\u2063"],[70,"\u2234\u2235"],[100,":"],[110,"\u03f6"],[150,"\u2026\u22ee\u22ef\u22f1"],[160,"\u220b"],[170,"\u22a2\u22a3\u22a4\u22a8\u22a9\u22ac\u22ad\u22ae\u22af"],[190,"\u2228"],
[200,"\u2227"],[240,"\u2201\u2208\u2209\u220c\u2282\u2283\u2284\u2285\u2286\u2287\u2288\u2289\u228a\u228b"],[241,"\u2264"],[242,"\u2265"],[243,">"],[244,"\u226f"],[245,"<"],[246,"\u226e"],[247,"\u2248"],[250,"\u223c\u2249"],[252,"\u2262"],[255,"\u2260"],[260,"=\u221d\u2224\u2225\u2226\u2241\u2243\u2244\u2245\u2246\u2247\u224d\u2254\u2257\u2259\u225a\u225c\u225f\u2261\u2268\u2269\u226a\u226b\u226d\u2270\u2271\u227a\u227b\u227c\u227d\u2280\u2281\u22a5\u22b4\u22b5\u22c9\u22ca\u22cb\u22cc\u22d4\u22d6\u22d7\u22d8\u22d9\u22ea\u22eb\u22ec\u22ed\u25a0\u25a1\u25aa\u25ab\u25ad\u25ae\u25af\u25b0\u25b1\u25b3\u25b4\u25b5\u25b6\u25b7\u25b8\u25b9\u25bc\u25bd\u25be\u25bf\u25c0\u25c1\u25c2\u25c3"+
"\u25c4\u25c5\u25c6\u25c7\u25c8\u25c9\u25cc\u25cd\u25ce\u25cf\u25d6\u25d7\u25e6\u29c0\u29c1\u29e3\u29e4\u29e5\u29e6\u29f3\u2a87\u2a88\u2aaf\u2ab0"],[265,"\u2044\u2206\u220a\u220d\u220e\u2215\u2217\u2218\u2219\u221f\u2223\u2236\u2237\u2238\u2239\u223a\u223b\u223d\u223e\u223f\u2242\u224a\u224b\u224c\u224e\u224f\u2250\u2251\u2252\u2253\u2255\u2256\u2258\u225d\u225e\u2263\u2266\u2267\u226c\u2272\u2273\u2274\u2275\u2276\u2277\u2278\u2279\u227e\u227f\u228c\u228d\u228e\u228f\u2290\u2291\u2292\u2293\u2294\u229a\u229b\u229c\u229d\u22a6\u22a7\u22aa\u22ab\u22b0\u22b1\u22b2\u22b3\u22b6\u22b7\u22b9\u22ba\u22bb\u22bc\u22bd\u22be\u22bf\u22c4\u22c6\u22c7"+
"\u22c8\u22cd\u22ce\u22cf\u22d0\u22d1\u22d2\u22d3\u22d5\u22da\u22db\u22dc\u22dd\u22de\u22df\u22e0\u22e1\u22e2\u22e3\u22e4\u22e5\u22e6\u22e7\u22e8\u22e9\u22f0\u22f2\u22f3\u22f4\u22f5\u22f6\u22f7\u22f8\u22f9\u22fa\u22fb\u22fc\u22fd\u22fe\u22ff\u25b2\u2758\u2981\u2982\u29a0\u29a1\u29a2\u29a3\u29a4\u29a5\u29a6\u29a7\u29a8\u29a9\u29aa\u29ab\u29ac\u29ad\u29ae\u29af\u29b0\u29b1\u29b2\u29b3\u29b4\u29b5\u29b6\u29b7\u29b8\u29b9\u29ba\u29bb\u29bc\u29bd\u29be\u29bf\u29c2\u29c3\u29c4"+"\u29c5\u29c6\u29c7\u29c8\u29c9\u29ca\u29cb\u29cc\u29cd\u29ce\u29cf\u29d0\u29d1\u29d2\u29d3\u29d4\u29d5\u29d6\u29d7\u29d8\u29d9\u29db\u29dc\u29dd\u29de\u29e0\u29e1\u29e2\u29e7\u29e8\u29e9\u29ea\u29eb\u29ec\u29ed\u29ee\u29f0\u29f1\u29f2\u29f5\u29f6\u29f7\u29f8\u29f9\u29fa\u29fb\u29fe\u29ff\u2a1d\u2a1e\u2a1f\u2a20\u2a21\u2a22\u2a23\u2a24\u2a25\u2a26\u2a27\u2a28\u2a29\u2a2a\u2a2b\u2a2c\u2a2d\u2a2e\u2a30\u2a31\u2a32\u2a33\u2a34\u2a35\u2a36\u2a37\u2a38\u2a39"+
"\u2a3a\u2a3b\u2a3c\u2a3d\u2a3e\u2a40\u2a41\u2a42\u2a43\u2a44\u2a45\u2a46\u2a47\u2a48\u2a49\u2a4a\u2a4b\u2a4c\u2a4d\u2a4e\u2a4f\u2a50\u2a51\u2a52\u2a53\u2a54\u2a55\u2a56\u2a57\u2a58\u2a59\u2a5a\u2a5b\u2a5c\u2a5d\u2a5e\u2a5f\u2a60\u2a61\u2a62\u2a63\u2a64\u2a65\u2a66\u2a67\u2a68\u2a69\u2a6a\u2a6b\u2a6c\u2a6d\u2a6e\u2a6f\u2a70\u2a71\u2a72\u2a73\u2a74\u2a75\u2a76\u2a77\u2a78\u2a79\u2a7a\u2a7b\u2a7c\u2a7d\u2a7e\u2a7f\u2a80\u2a81\u2a82\u2a83\u2a84\u2a85\u2a86\u2a89\u2a8a\u2a8b\u2a8c\u2a8d\u2a8e\u2a8f"+
"\u2a90\u2a91\u2a92\u2a93\u2a94\u2a95\u2a96\u2a97\u2a98\u2a99\u2a9a\u2a9b\u2a9c\u2a9d\u2a9e\u2a9f\u2aa0\u2aa1\u2aa2\u2aa3\u2aa4\u2aa5\u2aa6\u2aa7\u2aa8\u2aa9\u2aaa\u2aab\u2aac\u2aad\u2aae\u2ab1\u2ab2\u2ab3\u2ab4\u2ab5\u2ab6\u2ab7\u2ab8\u2ab9\u2aba\u2abb\u2abc\u2abd\u2abe\u2abf\u2ac0\u2ac1\u2ac2\u2ac3\u2ac4\u2ac5\u2ac6\u2ac7\u2ac8\u2ac9\u2aca\u2acb\u2acc\u2acd\u2ace\u2acf\u2ad0\u2ad1\u2ad2\u2ad3\u2ad4\u2ad5\u2ad6\u2ad7\u2ad8\u2ad9\u2ada\u2adb\u2add\u2add\u2ade\u2adf\u2ae0\u2ae1\u2ae2\u2ae3\u2ae4\u2ae5\u2ae6"+
...
"ma-nonbold");M.addClass(me,/italic/.test(s)?"ma-italic":"ma-upright");if(/double-struck/.test(s))M.addClass(me,"ma-double-struck");else if(/fraktur/.test(s))M.addClass(me,"ma-fraktur");else if(/script/.test(s))M.addClass(me,"ma-script");else if(/sans-serif/.test(s))M.addClass(me,"ma-sans-serif");return tok}function meScan(tagNameP){if(!tagNameP)tagNameP=scanWord("tagName");var tok=scanMeTok({mphantom:"phantom",menclose:"enclose"}[tagNameP]||tagNameP);return[newMe_(tagNameP,tok[0]),F.elem(tagNameP,
["mstyle","mphantom","mpadded"])?tok[1]:null]}function ovScan(){return[M.menclose(scanMeTok("\\ov")[0],{notation:"top"},docP_),null]}function minsizeScan(){var s=scanString("minsize"),tok=scanMeTok("minsize"),me=tok[0];if(M.mtagName(me)!="mo")throw"Can only stretch an operator symbol, before position "+M.re_.lastIndex;if(M.MathML)me.setAttribute("minsize",s);else{var r=Number(s);if(r>1)checkVertStretch(0.6*r,0.6*r,me,true);else me.style.fontSize=s}return tok}function mrow1Scan(){return[newMe_("mrow",
scanMeTok("\\mrowOne")[0]),null]}function binomScan(){function mtr1(e){return newMe_("mtr",newMe_("mtd",e))}var xMe=scanMeTok("\\binom")[0],yMe=scanMeTok("\\binom")[0],zMe=newMe_("mtable",F.map(mtr1,[xMe,yMe]));M.addClass(zMe,"ma-binom");if(!M.MathML){zMe.fmUp-=0.41;zMe.fmDn-=0.41}return[newMe_("mrow",[newMe_("mo","("),zMe,newMe_("mo",")")]),null]}M.macros_={mn:F(mtokenScan,"mn"),mi:F(mtokenScan,"mi"),mo:F(mtokenScan,"mo"),text:F(mtokenScan,"mtext"),html:htmlScan,sp:spScan,attr:attrScan,attrMML:F(attrScan,
null,true),id:F(attrScan,"id"),dir:F(attrScan,"dir"),cl:clScan,mv:mvScan,bo:F(mvScan,"bold"),it:F(mvScan,"italic"),bi:F(mvScan,"bold-italic"),sc:F(mvScan,"script"),bs:F(mvScan,"bold-script"),fr:F(mvScan,"fraktur"),ds:F(mvScan,"double-struck"),bf:F(mvScan,"bold-fraktur"),mstyle:F(meScan,"mstyle"),merror:F(meScan,"merror"),mpadded:F(meScan,"mpadded"),phantom:F(meScan,"mphantom"),enclose:F(meScan,"menclose"),ov:ovScan,minsize:minsizeScan,mrowOne:mrow1Scan,binom:binomScan};M.alias_={"-":M["-"],"'":"\u2032",
"\u212d":["C","fraktur"],"\u210c":["H","fraktur"],"\u2111":["I","fraktur"],"\u211c":["R","fraktur"],"\u2128":["Z","fraktur"],"\u212c":["B","script"],"\u2130":["E","script"],"\u2131":["F","script"],"\u210b":["H","script"],"\u2110":["I","script"],"\u2112":["L","script"],"\u2133":["M","script"],"\u211b":["R","script"],"\u212f":["e","script"],"\u210a":["g","script"],"\u2134":["o","script"]};var spaces_={",":".17em",":":".22em",";":".28em","!":"-.17em"};function scanTokP(){var match=M.re_.exec(s_);while(!match){M.re_.lastIndex=
s_.length;if(s_or_mx_i_==s_or_mx_a_.length)return null;var g=s_or_mx_a_[s_or_mx_i_++];if(typeof g=="string"){M.re_.lastIndex=0;s_=g;match=M.re_.exec(s_)}else if(g.nodeType==1)return[g,null];else F.err(err_scanTokP_)}var s1=match[2]||match[0],mvP=null;if(/^[_^}\u2196\u2199]$/.test(match[0])||match[2]&&M.macro1s_[s1])return[null,s1];if(match[0]=="{")return braceScan();if(match[2]&&M.macros_[s1])return M.macros_[s1]();if(match[1])return[M.newMe("mn",s1,docP_),null];if(/^[,:;!]$/.test(match[2]))s1="\u2009";
else if(match[2]=="/")s1="\u2215";else if(M.alias_[s1]&&!match[2]){var t=M.alias_[s1];if(typeof t=="string")s1=t;else{s1=t[0];mvP=t[1]}}var opSP=M.infix_[s1]||M.prefix_[s1]||M.postfix_[s1]?s1:null,e;if(s1=="\u2009")e=M.spaceMe(spaces_[match[2]||","],docP_);else if(opSP){e=M.newMe("mo",s1,docP_);if(/^[\u2200\u2203\u2204\u2202\u2207]$/.test(s1)){e.setAttribute("lspace",".11em");e.setAttribute("rspace",".06em")}else if(s1=="!"){e.setAttribute("lspace",".06em");e.setAttribute("rspace","0")}else if(s1==
"\u00d7"){e.setAttribute("lspace",".22em");e.setAttribute("rspace",".22em")}}else{e=M.newMe("mi",s1,docP_);if(match[2]&&s1.length==1){e.setAttribute("mathvariant","normal");M.addClass(e,"ma-upright");if(!M.MathML)e.style.paddingRight="0"}else if(mvP){e.setAttribute("mathvariant",mvP);M.addClass(e,"ma-upright");M.addClass(e,"ma-"+mvP)}if(/\w\w/.test(s1))M.addClass(e,"ma-repel-adj")}return[e,opSP]}function parse_mtd_tokP(optQ){var mxP_tokP=parse_mxP_tokP(M.infix_[","]),tokP=mxP_tokP[1]||scanTokP(),
mxP=mxP_tokP[0];if(!mxP){if(optQ&&!(tokP&&tokP[1]==","))return[null,tokP];mxP=emptyMe_()}var w=M.mtagName(mxP);if(w!="mtd"&&!(w=="mtr"&&optQ))mxP=M.newMe("mtd",mxP,docP_);return[mxP,tokP]}function parse_rowspan_tokP(){var v=scanString("rowspan"),mtd_tokP=parse_mtd_tokP(),mtd=mtd_tokP[0];mtd.setAttribute(M.MathML?"rowspan":"rowSpan",v);if(!M.hasClass(mtd,"middle"))M.addClass(mtd,"middle");return mtd_tokP}function parse_colspan_tokP(){var v=scanString("colspan"),mtd_tokP=parse_mtd_tokP();mtd_tokP[0].setAttribute(M.MathML?
"columnspan":"colSpan",v);return mtd_tokP}function parse_mtr_tokP(optQ){var mtds=[];while(true){var mtdP_tokP=parse_mtd_tokP(mtds.length==0),mtdP=mtdP_tokP[0],tokP=mtdP_tokP[1]||scanTokP();if(mtdP){if(M.mtagName(mtdP)=="mtr")return[mtdP,tokP];mtds.push(mtdP)}if(!(tokP&&tokP[1]==","))return[mtds.length||!optQ||tokP&&tokP[1]==";"?M.newMe("mtr",mtds,docP_):null,tokP]}}function parse_table_tokP(){var mtrs=[];while(true){var mtrP_tokP=parse_mtr_tokP(mtrs.length==0),mtrP=mtrP_tokP[0],tokP=mtrP_tokP[1]||
scanTokP();if(mtrP)mtrs.push(mtrP);if(!(tokP&&tokP[1]==";"))return[M.newMe("mtable",mtrs,docP_),tokP]}}function parse_math_tokP(){var mxP_tokP=parse_mxP_tokP(0);mxP_tokP[0]=M.newMe("math",mxP_tokP[0],docP_);return mxP_tokP}M.macro1s_={mtd:parse_mtd_tokP,rowspan:parse_rowspan_tokP,colspan:parse_colspan_tokP,mtr:parse_mtr_tokP,table:parse_table_tokP,math:parse_math_tokP};var embelWs_={"_":"sub","^":"sup","\u2199":"under","\u2196":"over"};function embelKP(op){var wP=embelWs_[op];return wP&&(wP.length<
4?"ss":"uo")}function parseEmbel(meTokP,tokP){while(true){if(!tokP)tokP=scanTokP();if(!tokP||tokP[0]||!embelWs_[tokP[1]]){if(tokP&&!meTokP){meTokP=tokP;tokP=null;continue}return[meTokP,tokP]}var k=embelKP(tokP[1]),parseMxs=function(){var mxs={},doneQs={};while(true){if(!tokP)tokP=scanTokP();if(!tokP||tokP[0])break;var op=tokP[1];if(embelKP(op)!=k||doneQs[op])break;doneQs[op]=true;tokP=scanTokP();if(tokP&&embelKP(tokP[1])==k&&!tokP[0])continue;var mxP_tokP=parse_mxP_tokP(999,tokP);mxs[op]=mxP_tokP[0];
tokP=mxP_tokP[1]}return mxs},mxs=parseMxs();if(k=="uo"||!tokP||(tokP[0]?meTokP:embelKP(tokP[1])!="ss")){if(!meTokP)meTokP=[emptyMe_(),null];var w="m",a=[meTokP[0]];F.iter(function(op){if(mxs[op]){w+=embelWs_[op];a.push(mxs[op])}},["_","^","\u2199","\u2196"]);if(a.length>1)meTokP=[M.newMe(w,a,docP_),meTokP[1]]}else{var mxsPA=[mxs];while(tokP&&!tokP[0]&&embelKP(tokP[1])=="ss")mxsPA.push(parseMxs());if(!meTokP)if(!tokP||!tokP[0])meTokP=[emptyMe_(),null];else{meTokP=tokP;tokP=scanTokP();var postA=[];
while(tokP&&!tokP[0]&&embelKP(tokP[1])=="ss")postA.push(parseMxs());mxsPA=postA.concat(null,mxsPA)}var a=[meTokP[0]];F.iter(function(mxsP){if(!mxsP)a.push(M.newMe("mprescripts",null,docP_));else a.push(mxsP["_"]||M.newMe("none",null,docP_),mxsP["^"]||M.newMe("none",null,docP_))},mxsPA);meTokP=[M.newMe("mmultiscripts",a,docP_),meTokP[1]]}}}function parse_mxP_tokP(prec,tokP){var mx0p=null;while(true){if(!tokP){tokP=scanTokP();if(!tokP)break}var op=tokP[1];if(!op||mx0p&&(tokP[0]?!(M.infix_[op]||M.postfix_[op]):
M.macro1s_[op]))if(!mx0p){mx0p=tokP[0];tokP=null}else{if(prec>=precAdj_)break;var mxP_tokP=parse_mxP_tokP(precAdj_,tokP),mx1=mxP_tokP[0];mx1||F.err(err_parse_mxP_tokP_1_);var e=M.newMe("mrow",[mx0p,mx1],docP_);if(M.hasClass(mx0p,"ma-repel-adj")||M.hasClass(mx1,"ma-repel-adj")){if(!(op&&tokP[0]&&M.prefix_[op]<25))$(mx0p).after(M.spaceMe(".17em",docP_));M.addClass(e,"ma-repel-adj")}mx0p=e;tokP=mxP_tokP[1]}else{var moP=tokP[0];if(moP){var precL=M.infix_[op]||M.postfix_[op];if(precL&&prec>=precL)break;
var precROpt=M.infix_[op]||!(mx0p&&M.postfix_[op])&&M.prefix_[op];if(!M.MathML&&!mx0p&&290<=precROpt&&precROpt<=350){$(moP).addClass("fm-large-op");moP.fmUp=0.85*1.3-0.25;moP.fmDn=0.35*1.3+0.25}var meTok_tokP=parseEmbel(tokP),a=[];meTok_tokP[0]||F.err(err_parse_mxP_tokP_embel_);var extOp=meTok_tokP[0][0];tokP=meTok_tokP[1];if(mx0p)a.push(mx0p);a.push(extOp);if(precROpt){var mxP_tokP=parse_mxP_tokP(precROpt,tokP);if(mxP_tokP[0])a.push(mxP_tokP[0]);tokP=mxP_tokP[1];if(precROpt<25&&!mx0p){if(!tokP)tokP=
scanTokP();if(tokP&&tokP[1]&&tokP[0]&&(M.postfix_[tokP[1]]||M.infix_[tokP[1]])==precROpt){a.push(tokP[0]);tokP=null}}}if(a.length==1)mx0p=a[0];else if(op=="/"&&mx0p&&a.length==3||op=="\u221a"&&!mx0p&&a.length==2)if(op=="\u221a"&&M.mtagName(a[0])=="msup")mx0p=M.newMe("mroot",[a[1],M.mchilds(a[0])[1]],docP_);else{a.splice(a.length-2,1);mx0p=M.newMe(op=="/"?"mfrac":"msqrt",a,docP_)}else{var e=M.newMe("mrow",a,docP_);if(op=="\u2009"||(precL||precROpt)>=precAdj_);else{var k="";if(op=="=")k="infix-loose";
else if(a.length==2){k=mx0p?"postfix":"prefix";if(M.infix_[op])k+="-tight";else{if(/^[\u2200\u2203\u2204\u2202\u2207]$/.test(op))k="quantifier";M.addClass(e,"ma-repel-adj")}}else if(mx0p){k=op==","||op==";"?"separator":precL<=270?"infix-loose":"infix";if(op=="|"&&M.MathML&&moP.tagName=="mo"){moP.setAttribute("lspace",".11em");moP.setAttribute("rspace",".11em")}}if(!M.MathML&&k&&!moP.style.fontSize)$(extOp).addClass("fm-"+k)}mx0p=e}}else if(op=="}")break;else if(M.macro1s_[op]){!mx0p||F.err(err_parse_mxP_tokP_macro_);
var mxP_tokP=M.macro1s_[op]();mx0p=mxP_tokP[0];tokP=mxP_tokP[1]}else{embelWs_[op]||F.err(err_parse_mxP_tokP_script_);if(prec>=999)break;var meTok_tokP=parseEmbel(mx0p&&[mx0p,null],tokP),meTok=meTok_tokP[0];meTok||F.err(err_parse_mxP_tokP_embel_2_);tokP=meTok_tokP[1];var a=[meTok[0]],opP=meTok[1];if(opP){var precROpt=M.infix_[opP]||M.prefix_[opP];if(precROpt){var mxP_tokP=parse_mxP_tokP(precROpt,tokP);if(mxP_tokP[0])a.push(mxP_tokP[0]);tokP=mxP_tokP[1]}}mx0p=a.length==1?a[0]:M.newMe("mrow",a,docP_)}}}return[mx0p,
tokP]}M.sToMe=function(g,docP){if(!docP)docP=document;M.infix_[""]&&M.infix_[","]||F.err(err_sToMe_1_);if(M.MathML==null)M.MathML=M.canMathML();M.re_.lastIndex=0;s_="";s_or_mx_a_=Array.isArray(g)?g:[g];s_or_mx_i_=0;docP_=docP;precAdj_=M.infix_[""];var mxP_tokP=parse_mxP_tokP(0);if(mxP_tokP[1])throw"Extra input:  "+mxP_tokP[1][1]+s_.substring(M.re_.lastIndex)+(s_or_mx_i_<s_or_mx_a_.length?"...":"");if(M.re_.lastIndex<s_.length||s_or_mx_i_<s_or_mx_a_.length)F.err(err_sToMe_2_);return mxP_tokP[0]};M.sToMathE=
function(g,blockQ,docP){var res=M.sToMe(g,docP);if(!(res&&F.elem(M.mtagName(res),["math","fmath"])))res=M.newMe("math",res,docP);if(typeof g=="string")res.setAttribute("alttext",g);return M.setMathBlockQ(res,blockQ)};M.$mathQ=true;M.inline$$Q=false;M.parseMath=function(nod){if(nod.nodeType==1&&nod.tagName!="SCRIPT")if(nod.tagName.toUpperCase()=="MATH"){var newE=M.eToMathE(nod);if(newE!=nod)nod.parentNode.replaceChild(newE,nod)}else for(var p=nod.firstChild;p;){var restP=p.nextSibling;M.parseMath(p);
p=restP}else if(nod.nodeType==3&&/[$\\]/.test(nod.data)){var doc=nod.ownerDocument,s=nod.data,a=[],t="",re=/\\([$\\])|\$\$?|\\[([]/g;while(true){var j=re.lastIndex,m=re.exec(s),k=m?m.index:s.length;if(j<k)t+=s.substring(j,k);if(m&&m[1])t+=m[1];else{var i=-1,z;if(m){z=m[0]=="\\("?"\\)":m[0]=="\\["?"\\]":m[0];if(re.lastIndex<s.length&&(m[0]!="$"||M.$mathQ)){i=s.indexOf(z,re.lastIndex);while(i!=-1&&s.charAt(i-1)=="\\")i=s.indexOf(z,i+1)}if(i==-1){t+=m[0];continue}}if(t){a.push(doc.createTextNode(t));
t=""}if(!m)break;var blockQ=m[0]=="$$"||m[0]=="\\[",e=M.sToMathE(s.substring(re.lastIndex,i),blockQ,doc);if(blockQ&&M.inline$$Q&&F.elem(nod.parentNode.nodeName,["P","SPAN"])){var wrap$=$("<div/>",doc).css("display","inline-block").append(e);e=wrap$[0]}a.push(e);re.lastIndex=i+z.length}}F.iter(function(x){nod.parentNode.insertBefore(x,nod)},a);nod.parentNode.removeChild(nod)}};M.parseMathQ=true;$(function(){if(M.MathML==null)M.MathML=M.canMathML();if(M.parseMathQ)try{M.parseMath(document.body)}catch(exc){alert(exc)}});
if($.fn.parseMath==null)$.fn.parseMath=function(){F.iter(M.parseMath,this);return this};return M}();var M;if(M===undefined)M=jqMath;
